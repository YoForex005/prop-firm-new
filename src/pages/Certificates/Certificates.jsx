...
function Certificates() {
    ...
    return (
        <div className="px-8 py-6 bg-[#f5f5f5] dark:bg-[#111827] min-h-screen">
            {/* Breadcrumbs */}
            ...
            {/* Header with Filters */}
            <div className="bg-white dark:bg-[#1f2937] rounded-t-xl px-8 pt-6">
            ...
            {/* Info Notice */}
            <div className="bg-white dark:bg-[#1f2937] px-8 py-4 flex items-start gap-3 text-[#666] dark:text-[#9ca3af] text-[13px] leading-relaxed">
            ...
            {/* Certificates Grid */}
            <div className="bg-white dark:bg-[#1f2937] rounded-b-xl p-8 grid grid-cols-2 gap-6 mb-6 max-md:grid-cols-[repeat(auto-fill,minmax(240px,1fr))] max-md:gap-4">
                {certificates.map((cert) => (
                    <div key={cert.id} className="relative aspect-[1.4/1] rounded-lg overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.1)] transition-transform duration-200 hover:-translate-y-1 hover:shadow-[0_4px_16px_rgba(0,0,0,0.15)] bg-white dark:bg-[#2d3748]">
            ...
            {/* Footer */}
            <div className="bg-white dark:bg-[#1f2937] rounded-xl px-8 py-6">
