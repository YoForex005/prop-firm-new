        ...
        <div className="flex h-[calc(100vh-40px)] bg-[var(--bg-color)]">
            ...
            <div className={`flex flex-col gap-4 bg-[var(--sidebar-bg)] border-r border-[#eee] dark:border-[#333] p-6 shrink-0 transition-[width] duration-300 relative z-10 dark:bg-transparent ${isCollapsed ? 'w-20 px-3 items-center' : 'w-[320px]'}`}>
                <div className="flex justify-between items-center mb-2 w-full">
                    ...
                    <button
                        className="w-7 h-7 border border-[#e5e7eb] dark:border-[#374151] rounded-md bg-white dark:bg-[#1f2937] text-[#6b7280] dark:text-[#9ca3af] flex items-center justify-center cursor-pointer"
                    ...
                    <>
                        <div className="flex gap-2.5 mt-1">
                            <div className="relative flex-1">
                                <button
                                    className={`w-full bg-white dark:bg-[#1f2937] border px-3 py-2 rounded-lg text-xs text-[#4b5563] dark:text-[#9ca3af] cursor-pointer flex items-center justify-between whitespace-nowrap transition-all duration-200 hover:bg-[#f9fafb] dark:hover:bg-[#374151] hover:border-[#d1d5db] dark:hover:border-[#4b5563] ${activeDropdown === 'types' ? 'border-[#2563eb] text-[#2563eb] bg-[#eff6ff] dark:bg-[#1e3a8a]/20 dark:text-[#60a5fa]' : 'border-[#e5e7eb] dark:border-[#374151]'}`}
                                ...
                                {activeDropdown === 'types' && (
                                    <div className="absolute top-[calc(100%+4px)] left-0 w-full min-w-[120px] bg-white dark:bg-[#1f2937] border border-[#e5e7eb] dark:border-[#374151] rounded-lg shadow-lg z-50 overflow-hidden p-1 animate-[fadeIn_0.1s_ease-out_forwards]">
                        ...
                        <div className="flex justify-end gap-2 mt-1">
                            <div className="relative group">
                                <button
                                    className={`relative w-12 h-7 rounded-full border bg-white dark:bg-[#1f2937] flex items-center justify-center cursor-pointer text-[#6b7280] dark:text-[#9ca3af] ${showArchived ? 'bg-[#eff6ff] border-[#bfdbfe] text-[#2563eb] dark:bg-[#1e3a8a]/20 dark:text-[#60a5fa] dark:border-[#1e3a8a]' : 'border-[#e5e7eb] dark:border-[#374151]'}`}
                            ...
                            <div className="relative group">
                                <button
                                    className={`relative w-12 h-7 rounded-full border bg-white dark:bg-[#1f2937] flex items-center justify-center cursor-pointer text-[#6b7280] dark:text-[#9ca3af] ${isCompactView ? 'bg-[#eff6ff] border-[#bfdbfe] text-[#2563eb] dark:bg-[#1e3a8a]/20 dark:text-[#60a5fa] dark:border-[#1e3a8a]' : 'border-[#e5e7eb] dark:border-[#374151]'}`}
            ...
            <div className="flex-1 flex items-center justify-center bg-[var(--bg-color)]">
                <div className="bg-white dark:bg-[#1f2937] w-[400px] border-2 border-dashed border-[#e5e7eb] dark:border-[#374151] rounded-2xl p-12 px-10 text-center flex flex-col items-center">
                    <div className="w-14 h-14 bg-[#f3f4f6] dark:bg-[#374151] rounded-xl flex items-center justify-center text-[#6b7280] dark:text-[#9ca3af] mb-6">
                    ...
                    <div className="bg-[#f8fafc] dark:bg-[#111827] w-full p-5 rounded-xl border border-[#f1f5f9] dark:border-[#374151]">
