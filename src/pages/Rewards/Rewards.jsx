    ...
    return (
        <div className="max-w-[1200px] mx-auto flex flex-col gap-8 p-0">
            ...
            <div className="flex gap-8 max-md:flex-col">
                ...
                <div className="flex-1 bg-white dark:bg-[#1f2937] rounded-xl p-10 border border-[#e0e0e0] dark:border-[#374151] shadow-[0_4px_12px_rgba(0,0,0,0.02)] min-h-[200px] flex flex-col justify-center items-center text-center">
                ...
                <div className="flex-1 bg-white dark:bg-[#1f2937] rounded-xl p-10 border border-[#e0e0e0] dark:border-[#374151] shadow-[0_4px_12px_rgba(0,0,0,0.02)] min-h-[200px] flex flex-col justify-center items-start text-left">
                    ...
                    <button className="bg-white dark:bg-transparent border border-[#e0e0e0] dark:border-[#4b5563] px-4 py-2 rounded-md text-[13px] font-medium text-[#1a1a1a] dark:text-[#e5e7eb] cursor-pointer transition-all duration-200 hover:bg-[#f9f9f9] dark:hover:bg-[#374151] hover:border-[#ccc] dark:hover:border-[#6b7280]">Request Reward</button>
                </div>
            </div>
